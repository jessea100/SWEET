...
data$age <- factor(data$age, 
                   levels = 1:13, 
                   labels = c("18 - 24", "25 - 29", "30 - 34", "35 - 39", "40 - 44", "45 - 49", "50 - 54", "55 - 59", "60 - 64", "65 - 69", "70 - 74", "75 - 79", "80 - 99"))
table(data$age)
```
...
data$gen_hlth <- factor(data$gen_hlth, 
                        levels = 1:8, 
                        labels = c("Excellent", "Excellent", "Very good", "Good", "Fair", "Poor", "Don’t know/Not Sure", "Refused"))
table(data$gen_hlth)
```
...
saveRDS(data, here("data/cleaned_data_basic.RDS"))
```
...
# Save all datasets
saveRDS(data_complete, here("data/cleaned_data_complete.RDS"))
saveRDS(data_imputed, here("data/cleaned_data_imputed.RDS"))
saveRDS(data_filtered, here("data/cleaned_data_filtered.RDS"))
