...
rf_error_df <- data.frame(
  OOB_ERROR = rf_model_large$err.rate[, "OOB"],  # OOB error rates
  ITERATION = seq_len(rf_model_large$ntree)      # Corresponding iterations
)
...
rf_final_model <- randomForest(
  ...
  importance = TRUE,               # Calculate variable importance
  ntree = optimal_n_trees          # Optimal number of trees
)
