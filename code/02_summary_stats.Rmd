...
# here i_am() is a function that allows you to navigate to the project directory
here::i_am("code/02_summary_stats.Rmd")

# Read your data (adjust path and read function as per your file)
data <- readRDS(here("data/cleaned_data/cleaned_data_complete.RDS"))
